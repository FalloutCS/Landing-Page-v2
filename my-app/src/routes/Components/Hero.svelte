...
<section
  class="flex flex-col lg:flex-row lg:justify-evenly lg:text-left justify-center items-center w-full h-screen bg-gradient-to-br from-skyblue-1 to-skyblue-5 text-center p-10"
>
